...
const setEntityStatus = (todolistId: string, entityStatus: RequestStatusType) => (
    {type: 'ENTINITY-STATUS', todolistId,  entityStatus
    }) as const
// thunks
